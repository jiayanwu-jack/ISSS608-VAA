...
This hands-on exercise demonstrates how to plot data visualisation for visualising correlation matrix with R. It consists of three main sections. First, create correlation matrix using [*pairs()*](https://www.rdocumentation.org/packages/graphics/versions/3.6.0/topics/pairs) of R Graphics. Next, plot corrgram using **corrplot** package of R. Lastly, create an interactive correlation matrix using plotly R.

## **10.2 Installing and Launching R Packages**

Code chunk below to install and launch **corrplot**, **ggpubr**, **plotly** and **tidyverse** in RStudio.
...
This section demonstrates how to create a scatterplot matrix by using the *pairs* function of R Graphics.
...
In this section is on how to visualising correlation matrix by using [*ggcorrmat()*](https://indrajeetpatil.github.io/ggstatsplot/reference/ggcorrmat.html) of [**ggstatsplot**](https://indrajeetpatil.github.io/ggstatsplot/index.html) package.
...
This section focus on corrplot.

Read [An Introduction to corrplot Package](https://cran.r-project.org/web/packages/corrplot/vignettes/corrplot-intro.html) to gain basic understanding of **corrplot** package.

### **10.7.1 Getting started with corrplot**

We need to compute the correlation matrix of wine data frame before plotting a corrgram using *corrplot().*
...
- colour scheme: diverging blue-red

Blue colours are used to represent pair variables with positive correlation coefficients and red colours are used to represent pair variables with negative correlation coefficients. The intensity of the colour or also know as **saturation** is used to represent the strength of the correlation coefficient. Darker colours indicate relatively stronger linear relationship between the paired variables. On the other hand, lighter colours indicates relatively weaker linear relationship.
...
![](images/clipboard-4063023037.png)
