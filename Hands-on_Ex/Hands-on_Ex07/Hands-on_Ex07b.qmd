...
### **15.2.1 Installing and launching R packages**
...
## **15.3 Importing Multiple Text Files from Multiple Folders**

### **15.3.1 Creating a folder list**

```{r}
news20 <- "data/20news/"
```

### **15.3.2 Define a function to read all files from a folder into a data frame**
...
## **15.4 Importing Multiple Text Files from Multiple Folders**

### **15.4.1 Reading in all the messages from the 20news folder**
...
Code chunk below presents the frequency of messages by newsgroup.
...
![](images/clipboard-120512561.png)

### **15.6.1 Removing header and automated email signitures**

Notice that each message has some structure and extra text that we don’t want to include in the analysis. For example, every message has a header, containing field such as “from:” or “in_reply_to:” that describe the message. Some also have automated email signatures, which occur after a line like “–”.
...
### **15.6.2 Removing lines with nested text representing quotes from other users.**
...
### **15.6.4 Visualising Words in newsgroups**
...
### **15.6.5 Visualising Words in newsgroups**
...
![](images/clipboard-508796412.png)

### **15.7.1 Computing tf-idf within newsgroups**
...
### **15.7.2 Visualising tf-idf as interactive table**
...
DT::datatable(
  ...
  DT::formatRound(columns = c("tf", "idf", "tf_idf"), digits = 3)
```

### **15.7.3 Visualising tf-idf as interactive table**
...
### **15.7.5 Counting and correlating pairs of words with the widyr package**
...
![](images/clipboard-920136260.png)
...
### **15.7.6 Visualising correlation as a network**
...
### **15.7.10 Counting the bigram again**
...
### **15.7.11 Create a network graph from bigram data frame**
...
### **15.7.12 Visualizing a network of bigrams with ggraph**
