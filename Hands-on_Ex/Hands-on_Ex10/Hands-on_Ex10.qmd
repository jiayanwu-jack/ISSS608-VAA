...
Learning Objective of this exercise:
...
This section demonstrates plotting sparklines by using ggplot2.
...
This section demonstrates how to create static information dashboard by using [gt](https://gt.rstudio.com/) and [gtExtras](https://jthomasmock.github.io/gtExtras/index.html) packages.

### Plotting a simple bullet chart

This section demonstrates how to prepare a bullet chart report by using functions of gt and gtExtras packages.
...
Code chunk below will be used to prepare the data.
...
Combine the bullet chart and sparklines using the steps below.
...
This section demonstrates how to create interactive information dashboard by using [reactable](https://glin.github.io/reactable/index.html) and [reactablefmtr](https://kcuilla.github.io/reactablefmtr/index.html) packages.
...
Values can be displayed as sparkbars as shown below.
